...
while usuario != 0 and usuario != 1 and usuario != 3:
    usuario = int(input("Selecione O Nivel De Acesso (CONSUMIDOR = 1) ou (ADMINISTRADOR = 0)  \n:"))
...
## PIX ##
        ...
        telefone = input("Digite O Seu Telefone No Formato (DD 99999999)")

        matriz.append([valor, telefone])

        print("Compra finalizada, obrigado por comprar na Blaze Refris!")
